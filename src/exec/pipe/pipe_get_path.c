...
/*   Updated: 2023/03/30 17:07:44 by lcompieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../../header/minishell.h"

void	join_path(char **path_split, char *cmd, int index, t_env_pipe *st)
{
	char	*temp;
...
void	set_path(char **path_split, char *cmd, t_env_pipe *st)
{
	int		index;
